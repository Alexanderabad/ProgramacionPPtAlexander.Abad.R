...
if (res)
    fputs("\n", ar);
/* Se indica un salto de línea, excepto en la ultima cadena. Si no
   se hiciera esta indicación, la funcion fputs pegaría las cadenas y
   luego tendríamos dificultades en el momento de leerlas. */
}
fclose(ar);
}
else
